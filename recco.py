...
data["addresslas"] = data.address.apply(lambda x: x.split(' ')[-1])
...
data.drop(['start_party', 'end_party', 'created_at', 'updated_at',
       'owner_id', 'verified'],1,inplace=True)

...
Route::group([
    ...
    Route::group(['namespace' => 'Supplier',], function () {
        ...
        Route::get('viewConfirmedBookingsPlans', [SupplierController::class, 'viewConfirmedBookingsPlans']);
        Route::get('viewCancelledBookingsPlans', [SupplierController::class, 'viewCancelledBookingsPlans']);
        Route::get('viewBookingsplans', [SupplierController::class, 'viewBookingsplans']);
        Route::post('confirmBookingPlan/{bookingplanId}', [SupplierController::class, 'confirmBookingPlan']);
        Route::post('rejectBookingPlan/{bookingplanId}', [SupplierController::class, 'rejectBookingPlan']);
    });
});

...
# Retrieve the user ID from command-line argument
user_id = sys.argv[1]
...
# Call the recommendation function with the user ID from Laravel API
recommended_halls_json = recommend_halls(user_id=user_id)

# Convert the output to JSON format
recommendations_json = json.dumps({"user_id": user_id, "recommended_halls": recommended_halls_json})

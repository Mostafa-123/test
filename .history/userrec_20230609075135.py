...
print(likes_data.dtypes)
print(booking_data.dtypes)



print(likes_data['hall_id'].unique())
print(booking_data['hall_id'].unique())
...
user_item_matrix.columns = map(str.lower, user_item_matrix.columns)

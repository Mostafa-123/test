...
# Read the user ID from command-line argument
# user_id = sys.argv[1]
...
# Combine user preferences from likes, comments, and favorites
...
def recommend_halls(user_id, top_n=5):
    ...
    return recommended_halls.tolist()

# Get recommendations for the provided user ID
recommended_halls = recommend_halls(user_id)

# Format the recommendations as JSON
recommendations = {"user_id": user_id, "recommended_halls": recommended_halls}
recommendations_json = json.dumps(recommendations)

# Print the recommendations JSON

...
Route::group([
    ...
    Route::group(['namespace' => 'Supplier',], function () {
        ...
        Route::get('/getSupplierConfirmedSubReqests', [BookingController::class, 'getSupplierConfirmedSubReqests']);//1
        Route::get('/getSupplierUnConfirmedSubReqests', [BookingController::class, 'getSupplierUnConfirmedSubReqests']);//1
        Route::get('/getSupplierCancelledSubReqests', [BookingController::class, 'getSupplierCancelledSubReqests']);//1

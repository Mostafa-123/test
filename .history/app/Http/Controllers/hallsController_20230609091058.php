...
public function getRecommendations22(Request $request)
{
    $targetUserId = Auth::guard('user-api')->id();
...
public function getRecommendations4(Request $request)
{
...
public function getRecommendations()
{
    $halls = Hall::withCount('likes')
        ...
        ->take(10) // Adjust the number of halls you want to retrieve
        ->get();

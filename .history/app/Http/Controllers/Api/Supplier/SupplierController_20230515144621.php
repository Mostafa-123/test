...
class SupplierController extends Controller
{
    ...
    public function getSupplierAllSubReqestsa()
    {
        $bookingplans = PlanRequest::where('status', 'unconfirmed')->where('supplier_id', 'unconfirmed')->get();
        ...
        $bookingplans = SubRequest::where('status', 'unconfirmed')->where('supplier_id', 'unconfirmed')->get();
    ...
    public function confirmSubRequest($bookingplanId)
    {
        ...
        $actor_id = Auth::guard('supplier-api')->user()->id;

        if ($supplier_id == $actor_id) {
    ...
    public function rejectSubRequest($bookingplanId)
    {
        $bookingplan = SubRequest::findOrFail($bookingplanId);

 ...
 */
        ...
        $result->country=$validatedData['country'];
        $result->city=$validatedData['city'];
        $result->street=$validatedData['street'];
        $result->rooms=$validatedData['rooms'];
        $result->chairs=$validatedData['chairs'];
        $result->price=$validatedData['price'];
        $result->hours=$validatedData['hours'];
        $result->tables=$validatedData['tables'];
        $result->available=$validatedData['available'];
        $result->type=$validatedData['type'];
        $result->capacity=$validatedData['capacity'];
        $result->owner_id = auth::guard('owner-api')->user()->id;;

 ...
 */
        $newhall=new Hall();
        $newhall->name=$validatedData['name'];
        $newhall->address=$validatedData['address'];
        $newhall->country=$validatedData['country'];
        $newhall->city=$validatedData['city'];
        $newhall->street=$validatedData['street'];
        $newhall->rooms=$validatedData['rooms'];
        $newhall->chairs=$validatedData['chairs'];
        $newhall->price=$validatedData['price'];
        $newhall->hours=$validatedData['hours'];
        $newhall->tables=$validatedData['tables'];
        $newhall->available=$validatedData['available'];
        $newhall->owner_id = auth()->guard('owner-api')->user()->id;;
        $newhall->start_party=$validatedData['start_party'];
        $newhall->end_party=$validatedData['end_party'];

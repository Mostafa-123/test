 ...
 */
        $newhall=new Hall();
        $newhall->name=$validator['name'];
        $newhall->address=$validator['address'];
        $newhall->country=$validator['country'];
        $newhall->city=$validator['city'];
        $newhall->street=$validator['street'];
        $newhall->rooms=$validator['rooms'];
        $newhall->chairs=$validator['chairs'];
        $newhall->price=$validator['price'];
        $newhall->hours=$validator['hours'];
        $newhall->tables=$validator['tables'];
        $newhall->available=$validator['available'];
        $newhall->owner_id = auth()->guard('owner-api')->user()->id;;
        $newhall->start_party=$validator['start_party'];
        $newhall->end_party=$validator['end_party'];

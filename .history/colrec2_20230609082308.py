...
recommended_halls_json = recommend_halls(user_id=actual_user_id)

# Convert the output to JSON format
recommendations_json = json.dumps({"user_id": actual_user_id , "recommended_halls": recommended_halls_json.tolist()})
